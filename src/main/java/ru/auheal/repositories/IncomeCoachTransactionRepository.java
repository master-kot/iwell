...
import ru.auheal.entities.IncomeCoachTransaction;

/**
 * Репозиторий входящих транзакций тренеров
 */

public interface IncomeCoachTransactionRepository extends JpaRepository<IncomeCoachTransaction, Long>, JpaSpecificationExecutor<IncomeCoachTransaction> {
    /*
